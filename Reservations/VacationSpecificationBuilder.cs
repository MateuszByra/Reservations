...
namespace Reservations
{
    public class VacationSpecificationBuilder
    {
        ...
        {
            IVacationPart part =
                this.partFactory.CreateHotelReservation(this.destinationTown, hotelName, this.arrivalDate,
        ...
        {
            return 
                this.partFactory.CreateFlight(companyName,this.livingTown, this.destinationTown,this.arrivalDate);
        }

        private IVacationPart CreateFlightBack(string companyName)
        {
            return
                this.partFactory.CreateFlight(companyName, this.destinationTown, this.livingTown, 
                                                this.arrivalDate.AddDays(this.totalNights));
        }
